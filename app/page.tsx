        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
            ...
            <section className="max-w-7xl mx-auto px-4 py-20 text-center">
                ...
                <div className="flex gap-4 justify-center">
                    <a
                        href="#planes"
                        className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-8 rounded-xl text-lg shadow-lg transition-all"
                    >
                        Empezar Gratis
                    </a>
                    <Link
                        href="/login"
                        className="bg-white hover:bg-gray-50 text-gray-900 font-bold py-4 px-8 rounded-xl text-lg shadow-lg transition-all border-2 border-gray-200"
                    >
                        Ya tengo cuenta
                    </Link>
                </div>
            ...
            {/* Planes Section */}
            <section id="planes" className="max-w-7xl mx-auto px-4 py-20">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">
                        Elegí tu Plan
                    </h2>
                    <p className="text-xl text-gray-600 mb-4">
                        Probá gratis por 15 días, después elegí el plan que mejor se adapte a tu negocio
                    </p>
                    <div className="inline-block bg-green-100 text-green-800 px-6 py-3 rounded-full text-lg font-semibold">
            ...
            <section className="max-w-7xl mx-auto px-4 py-20">
                <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-3xl shadow-2xl p-12 text-center text-white">
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-3 bg-white text-green-600 font-bold py-4 px-8 rounded-xl text-lg shadow-lg hover:shadow-xl transition-all"
                    >
