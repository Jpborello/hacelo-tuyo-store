                ...
                <div className="relative overflow-hidden rounded-3xl"
                    ...
                    <div className="relative z-10 p-8 md:p-14 text-center">
                        ...
                        <div className="inline-flex items-center gap-2 mb-8 px-4 py-1.5 rounded-full"
                            ...
                            <span className="text-sm font-medium" style={{ color: '#25D366', letterSpacing: '0.05em' }}>
                                Disponible ahora
                            </span>
                        </div>

                        <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#f8fafc', letterSpacing: '-0.02em', lineHeight: 1.2 }}>
                            ¿Tenés alguna consulta?
                        </h2>
                        <p className="text-base md:text-lg mb-10 mx-auto max-w-md" style={{ color: 'rgba(248,250,252,0.55)', lineHeight: 1.7 }}>
                            Contactate con un asesor y encontramos juntos el plan ideal para tu negocio.
                        </p>

                        {/* Botón WhatsApp */}
                        <a
                            href="https://wa.me/5493413187739?text=Hola%20Andr%C3%A9s!%20Estoy%20interesado%20en%20Hacelotuyo%20y%20quer%C3%ADa%20m%C3%A1s%20informaci%C3%B3n"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group inline-flex items-center justify-center gap-3 font-semibold py-4 px-8 rounded-2xl text-base transition-all duration-300"
                            style={{
                        ...
                        {/* Info contacto */}
                        <p className="mt-6 text-xs" style={{ color: 'rgba(248,250,252,0.3)', letterSpacing: '0.08em' }}>
                            Andrés · +54 9 3413 18-7739
                        </p>
                    </div>
                </div>
            </section>
